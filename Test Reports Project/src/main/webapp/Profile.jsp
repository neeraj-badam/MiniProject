...
<body>
	...
	<%
		...
		String generate = "";
			if(s.equals("admin"))
			{
				generate = "<li><a href='ReportRetrieval.jsp'>PrintReport</a></li>"+"<li><a href='GenerateReport.jsp'>GenerateReport</a></li>";
			}
			else
			{
				generate = "<li><a href='ReportRetrieval.jsp'>PrintReport</a></li>";
			}
	%>
